...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-09 14:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ef682961-8be0-49a1-9bdd-cb7235fa415a.git
$ cd ef682961-8be0-49a1-9bdd-cb7235fa415a
```
